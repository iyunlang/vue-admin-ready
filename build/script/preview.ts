...
import Koa, { Middleware, ParameterizedContext, DefaultState, DefaultContext } from 'koa';
...
const startApp = () => {
  ...
  app.use(staticServer(resolve(process.cwd(), outDir)) as Middleware<ParameterizedContext<DefaultState, DefaultContext>>);
